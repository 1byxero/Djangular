...
var FetchmeetingsService = (function () {
    ...
    FetchmeetingsService.prototype.handleError = function (error) {
        console.error('An error Occured', error);
        return Promise.reject(error.message || error);
    };
    FetchmeetingsService = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [http_1.Http])
    ], FetchmeetingsService);
    return FetchmeetingsService;
}());
exports.FetchmeetingsService = FetchmeetingsService;
//# sourceMappingURL=fetchuserdata.service.js.map